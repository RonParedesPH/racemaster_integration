...
class RowsServerSide {
    constructor() {
        ...
        this._staticHeight = 67;

        // Path to the api for getting and setting items
        this._apiPath = 'http://localhost:52764/api';
    ...
    _createInstance() {
        ...
        this._datatable = jQuery('#datatableRowsAjax').DataTable({
            ...
            columns: [
                ...
                { data: 'ItemCategory1.CategoryCode', name: 'ItemCategory1.CategoryCode' },
